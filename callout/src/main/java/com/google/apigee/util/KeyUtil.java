...
public class KeyUtil {
  ...
  public static PrivateKey decodePrivateKey(String privateKeyPemString, String password) throws IOException, PKCSException, PEMException, OperatorCreationException {
